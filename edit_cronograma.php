...
$query_calendario_aulas = "SELECT id_aula, DAY(aula.dia) AS dia_aula, MONTH(aula.dia) AS mes, professor.nome AS nome, uc_componente.nome AS uc, local.numero AS sala FROM aula 
...
INNER JOIN curso ON aula.id_curso = curso.id_curso WHERE curso.id_curso = $id_curso AND aula.id_turma = $id_turma";
...
$query_dados_uc = "SELECT aula.id_curso, aula.id_turma, COUNT(*) AS quantidade, uc_componente.id_uc_componente, SUM(HOUR(aula.hora_termino) - HOUR(aula.hora_inicio)) AS horas_cadastradas, uc_componente.nome AS nome_uc, uc_componente.carga_horaria AS ch_uc_componente FROM `aula` 
INNER JOIN uc_componente ON aula.id_uc_componente = uc_componente.id_uc_componente WHERE uc_componente.id_uc_componente = $id_uc AND id_curso = $id_curso AND aula.id_turma = $id_turma";
...
function calendario($result_calendario_aulas, $resultFeriados, $id_turma, $id_curso, $id_professor, $id_uc, $id_local, $mes, $ano){
    ...
    while($resultado_calendario_aulas = mysqli_fetch_assoc($result_calendario_aulas)){
        $feriados[$resultado_calendario_aulas['dia_aula']."-".$resultado_calendario_aulas['mes']] = "&nbsp;&nbsp;<a href='excluir_aula.php?scroll=750&id_aula=".$resultado_calendario_aulas['id_aula']."&id_turma=".$id_turma."&id_curso=".$id_curso."&id_professor=".$resultado_calendario_aulas['id_professor']."&id_uc=".$resultado_calendario_aulas['id_uc_componente']."&id_local=".$resultado_calendario_aulas['id_local']."&mes=".$mes."&ano=".$ano."&local=edit_cronograma'><i class='bi bi-trash-fill'></i></a> <br>".$resultado_calendario_aulas['nome']."<br>".$resultado_calendario_aulas['uc']."<br>".$resultado_calendario_aulas['sala'];
    }
    ...
    <div id="app">
        ...
        <div id="main">
            ...
            <div class="page-heading">
                ...
                <!-- Inicio Formulário -->
                <form method="POST" action="gera_cronograma_aprendizagem.php?scroll=750&local=edit_cronograma" id="formCronograma">
                    <section id="input-with-icons">
                        <div class="row match-height">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title">Editar Cronograma</h4>
                                    </div>
                                                ...
                                                <div class="col-sm-6 mb-4">
                                                    ...
                                                    <div class="form-group">
                                                        <h4>
                                                            ...
                                                            <input type="hidden" value="edit_cronograma" name="local">
            ...
            <div class="card">
                <div class="card-body">
                    <?php
                        //gera calendario
                        echo calendario($result_calendario_aulas, $resultFeriados, $id_turma, $id_curso, $id_professor, $id_uc, $id_local, $mes, $ano);
                    ?>
                </div>
            </div>
            </div>
