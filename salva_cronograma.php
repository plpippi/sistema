<?php
    ...
    $query = "SELECT aula.dia, aula.hora_inicio, professor.nome AS professor, turma.nome AS turma, turma.numero_turma, uc_componente.nome AS uc_c FROM aula 
    ...
    WHERE aula.id_turma = '$turma' ORDER BY aula.dia ASC"; 
...
<html>
    ...
    <body>
        <div class='container'>
            <div class='row'>
                <div class='col col-sm-12'>
                    ...
                    <br><b style='font-size:62px;'>".$nome_turma."</b><br><br>
        ...
        while($resultado = mysqli_fetch_assoc($result)){ 
            $html .= "<tr>";
            $html .= "<td>".$resultado['professor']."</td>";
            $html .= "<td>".$resultado['numero_turma']."</td>";
            $html .= "<td>".$resultado['uc_c']."</td>";
            $html .= "<td>".$resultado['hora_inicio']."</td>";
