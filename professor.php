                            ...
                            <table class="table table-striped" id="table1">
                                ...
                                <tbody>
                                    <?php while ($resultado = mysqli_fetch_assoc($result)) { ?>
                                        ...
                                        <td><a href="https://wa.me/55<?php echo $resultado['telefone']; ?>" target="_blanck"><i class="bi bi-whatsapp"></i>&nbsp;&nbsp;<?php echo $resultado['telefone']; ?></a></td>
                                        ...
                                        <td>
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#ferias<?php echo $resultado['id_professor']; ?>"><i class="bi bi-file-plus-fill"></i> &nbsp;Cadastrar Férias</a>
                                                ...
                                                <div class="dropdown-divider"></div>
                                                <a class="dropdown-item" href="calendario_professor.php?id_professor=<?php echo $resultado['id_professor']; ?>"><i class="bi bi-calendar-fill"></i> &nbsp;Visualizar Cronograma</a>
                                                <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#salvaC<?php echo $resultado['id_professor']; ?>"><i class="bi bi-calendar-fill"></i> &nbsp;Salvar Cronograma</a>
                                                <div class="dropdown-divider"></div>
                                                <?php
                                                if ($resultado['status'] == 1) {
                                        ...
                                        <!-- Inicio Modal salvar cronograma -->

                                        <div class="modal fade text-left" id="salvaC<?php echo $resultado['id_professor']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h4 class="modal-title" id="myModalLabel33">Gerar Cronograma</h4>
                                                        <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                                                            <i data-feather="x"></i>
                                                        </button>
                                                    </div>
                                                    <form method="GET" action="salva_calendario_docente.php" enctype="multipart/form-data">
                                                        <div class="modal-body">
                                                            <label>Data Inicio</label>
                                                            <div class="form-group">
                                                                <input type="date" class="form-control" name="data_inicio" id="data_inicio">
								<input type="hidden" name="id_professor" value="<?php echo $resultado['id_professor']; ?>">
								<input type="hidden" name="nomeProf" value="<?php echo $resultado['nome']; ?>">
                                                            </div>
                                                        ...
                                                        <div class="modal-footer">
                                                            <button type="submit" class="btn btn-primary ml-1">
                                                                ...
                                                                <span class="d-none d-sm-block">Salvar Cronograma</span>
                                                            </button>
                                        ...
                                        <!-- Inicio Modal Substituir Professor-->
                                        ...
                                        <!-- Fim Modal  Substituir Professor -->

                                        <!-- Inicio Modal Ferias -->

                                        <div class="modal fade text-left" id="ferias<?php echo $resultado['id_professor']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h4 class="modal-title" id="myModalLabel33">Informar Férias</h4>
                                                        <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                                                            <i data-feather="x"></i>
                                                        </button>
                                                    </div>
                                                    <form method="POST" action="salva_ferias.php" enctype="multipart/form-data">
                                                        <div class="modal-body">
                                                            <div class="row">
                                                            <div class="col-sm-6 mb-6">
                                                            <h6>Data de Inicio</h6>
                                                            <div class="form-group">
                                                                 <input type="date" class="form-control" placeholder="Informe a data de inicio" id="data_inicio" name="data_inicio">
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-6 mb-6">
                                                            <h6>Data de Término</h6>
                                                            <div class="form-group">
                                                                 <input type="date" class="form-control" placeholder="Informe a data de término" id="data_fim" name="data_fim">
                                                            </div>
                                                        </div>
                                                            </div>
                                                        </div>
                                                        <div class="modal-footer">
                                                            <input type="hidden" id="id_professor" name="id_professor" value="<?php echo $resultado['id_professor']; ?>">
                                                            <button type="submit" class="btn btn-primary ml-1">
                                                                <i class="bx bx-check d-block d-sm-none"></i>
                                                                <span class="d-none d-sm-block">Salvar Férias</span>
                                                            </button>
                                                            <button type="button" class="btn btn-light-secondary" data-bs-dismiss="modal">
                                                                <i class="bx bx-x d-block d-sm-none"></i>
                                                                <span class="d-none d-sm-block">Cancelar</span>
