...
include('menu.php');
$query = "SELECT * FROM turma WHERE turma.tipo_turma = 3 ORDER BY id_turma ASC";
                ...
                <section class="section">
                    <div class="card">
                        <div class="card-header">
                            <a href="cad_turma_aprendizagem.php" class="btn btn-primary">Cadastrar Turma</a>
                        </div>
                        <div class="card-body">
                                    ...
                                    <?php while ($resultado = mysqli_fetch_assoc($result)) { ?>
                                        ...
                                        <td>
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" href="cad_turma_aprendizagem.php?acao=1&id_turma=<?php echo $resultado['id_turma']; ?>"><i class="bi bi-pencil-square"></i> &nbsp;Editar</a>
                                                ...
                                                <a class="dropdown-item" href="cad_cronograma_aprendizagem.php?id_turma=<?php echo $resultado['id_turma']; ?>&id_curso=<?php echo $resultado['curso']; ?>&ano=<?php echo date('Y'); ?>&mes=<?php echo date('m'); ?>"><i class="bi bi-file-plus-fill"></i> &nbsp;Cadastrar Cronograma</a>
						<a class="dropdown-item" href="cad_cronograma.php?id_turma=<?php echo $resultado['id_turma']; ?>&id_curso=<?php echo $resultado['curso']; ?>"><i class="bi bi-file-plus-fill"></i> &nbsp;Gerar Cronograma</a>
